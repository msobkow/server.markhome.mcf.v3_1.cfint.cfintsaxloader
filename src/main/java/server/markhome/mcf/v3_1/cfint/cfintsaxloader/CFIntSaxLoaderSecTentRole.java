...
/*
 *	CFIntSaxLoaderSecTentRoleParse XML SAX Element Handler implementation
 *	for SecTentRole.
 */
public class CFIntSaxLoaderSecTentRole
	extends CFLibXmlCoreElementHandler
{
	public CFIntSaxLoaderSecTentRole( CFIntSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFIntSecTentRoleObj origBuff = null;
		ICFIntSecTentRoleEditObj editBuff = null;
		// Common XML Attributes
		String attrId = null;
		// SecTentRole Attributes
		// SecTentRole References
		ICFIntSecSysGrpObj refRole = null;
		...
		try {
			...
			origBuff = (ICFIntSecTentRoleObj)schemaObj.getSecTentRoleTableObj().newInstance();
			editBuff = (ICFIntSecTentRoleEditObj)origBuff.beginEdit();
			...
			if( scopeObj == null ) {
				...
				refRole = (ICFIntSecSysGrpObj) scopeObj;
			...
			ICFIntSecTentRoleObj origSecTentRole = (ICFIntSecTentRoleObj)schemaObj.getSecTentRoleTableObj().readSecTentRoleByUNameIdx( refTenant.getRequiredId(),
			...
			if( editSecTentRole != null ) {
				if( origSecTentRole != null ) {
					...
					origSecTentRole = (ICFIntSecTentRoleObj)editSecTentRole.create();
				}
				editSecTentRole = null;
			}
