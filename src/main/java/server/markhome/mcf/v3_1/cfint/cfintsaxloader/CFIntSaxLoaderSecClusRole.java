...
/*
 *	CFIntSaxLoaderSecClusRoleParse XML SAX Element Handler implementation
 *	for SecClusRole.
 */
public class CFIntSaxLoaderSecClusRole
	extends CFLibXmlCoreElementHandler
{
	public CFIntSaxLoaderSecClusRole( CFIntSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFIntSecClusRoleObj origBuff = null;
		ICFIntSecClusRoleEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFIntSecClusRoleObj)schemaObj.getSecClusRoleTableObj().newInstance();
			editBuff = (ICFIntSecClusRoleEditObj)origBuff.beginEdit();
			...
			ICFIntSecClusRoleObj origSecClusRole = (ICFIntSecClusRoleObj)schemaObj.getSecClusRoleTableObj().readSecClusRoleByUNameIdx( editBuff.getRequiredClusterId(),
			...
			if( editSecClusRole != null ) {
				if( origSecClusRole != null ) {
					...
					origSecClusRole = (ICFIntSecClusRoleObj)editSecClusRole.create();
				}
				editSecClusRole = null;
			}
