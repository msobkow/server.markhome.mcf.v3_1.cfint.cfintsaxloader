...
/*
 *	CFIntSaxLoaderSecRoleMembParse XML SAX Element Handler implementation
 *	for SecRoleMemb.
 */
public class CFIntSaxLoaderSecRoleMemb
	extends CFLibXmlCoreElementHandler
{
	public CFIntSaxLoaderSecRoleMemb( CFIntSaxLoader saxLoader ) {
		super( saxLoader );
	}
	...
	throws SAXException
	{
		...
		ICFIntSecRoleMembObj origBuff = null;
		ICFIntSecRoleMembEditObj editBuff = null;
		...
		try {
			...
			origBuff = (ICFIntSecRoleMembObj)schemaObj.getSecRoleMembTableObj().newInstance();
			editBuff = (ICFIntSecRoleMembEditObj)origBuff.beginEdit();
			...
			CFIntSaxLoader.LoaderBehaviourEnum loaderBehaviour = saxLoader.getSecRoleMembLoaderBehaviour();
			ICFIntSecRoleMembEditObj editSecRoleMemb = null;
			ICFIntSecRoleMembObj origSecRoleMemb = (ICFIntSecRoleMembObj)schemaObj.getSecRoleMembTableObj().readSecRoleMembByIdIdx( refRole.getRequiredSecRoleId(),
			...
			if( origSecRoleMemb == null ) {
				...
				switch( loaderBehaviour ) {
					case Insert:
						break;
					case Update:
						editSecRoleMemb = (ICFIntSecRoleMembEditObj)origSecRoleMemb.beginEdit();
			...
			if( editSecRoleMemb != null ) {
				if( origSecRoleMemb != null ) {
					...
					origSecRoleMemb = (ICFIntSecRoleMembObj)editSecRoleMemb.create();
				}
				editSecRoleMemb = null;
			}
