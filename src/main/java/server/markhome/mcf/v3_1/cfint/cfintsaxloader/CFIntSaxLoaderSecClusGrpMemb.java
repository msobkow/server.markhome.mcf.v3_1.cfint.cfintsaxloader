	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntSecClusGrpMembObj origSecClusGrpMemb = (ICFIntSecClusGrpMembObj)schemaObj.getSecClusGrpMembTableObj().readSecClusGrpMembByIdIdx( refGroup.getRequiredSecClusGrpId(),
