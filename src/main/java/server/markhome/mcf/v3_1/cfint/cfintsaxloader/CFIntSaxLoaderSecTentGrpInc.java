	...
	extends CFLibXmlCoreElementHandler
{
	...
	throws SAXException
	{
		...
		try {
			...
			ICFIntSecTentGrpIncObj origSecTentGrpInc = (ICFIntSecTentGrpIncObj)schemaObj.getSecTentGrpIncTableObj().readSecTentGrpIncByIdIdx( refGroup.getRequiredSecTentGrpId(),
